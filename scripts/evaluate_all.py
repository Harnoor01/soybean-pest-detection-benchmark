...
ALL_EXPERIMENTS = {
    ...
    # Three distinct detector paradigms, same data/split/imgsz/epochs:
    #   YOLOv8s  — CNN one-stage, anchor-free, NMS, SGD         (2023)
    #   RT-DETR-L— Transformer-based, attention, NMS-free, AdamW (2023)
    #   YOLO26s  — CNN one-stage, NMS-free, STAL, MuSGD         (2025)
    "E1_yolov8s":  ("yolo", "E1_yolov8s/weights/best.pt"),
    "E1_rtdetr":   ("yolo", "E1_rtdetr/weights/best.pt"),   # RTDETR uses same eval API
    "E1_yolo26s":  ("yolo", "E1_yolo26s/weights/best.pt"),

    # ── E2: Mosaic scheduling ablation (YOLOv8s, close_mosaic ∈ {0, 10, 50}) ──
    # close_mosaic is a training-only parameter — inference speed is identical
    # across all three conditions, so speed benchmarking is NOT needed for E2.
    "E2_close_mosaic_0":  ("yolo", "E2_close_mosaic_0/weights/best.pt"),
    "E2_close_mosaic_10": ("yolo", "E2_close_mosaic_10/weights/best.pt"),
    "E2_close_mosaic_50": ("yolo", "E2_close_mosaic_50/weights/best.pt"),
}
